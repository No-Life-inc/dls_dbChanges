...
RABBITMQ_STORIES_QUEUE = 'new_stories'
...
# Declare the queues
channel.queue_declare(queue=RABBITMQ_STORIES_QUEUE, durable=True)
...
channel.basic_consume(queue=RABBITMQ_STORIES_QUEUE, on_message_callback=story_callback)
